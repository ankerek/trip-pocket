...
export const DEMO_SCREENSHOT: DemoScreenshotFixture = {
  handle: '@tokyo.eats',
  heroImageUrl:
    'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=900&q=75',
  ...
  reveals: [
    {
      ...
      category: 'food',
      photoUrl:
        'https://images.unsplash.com/photo-1583032015879-e5022cb87c3b?w=400&q=70',
    },
    {
      name: 'Ichiran',
      city: 'Shibuya',
      category: 'food',
      photoUrl:
        'https://images.unsplash.com/photo-1591814468924-caf88d1232e1?w=400&q=70',
    },
    {
      name: 'Afuri Ramen',
      city: 'Shibuya',
      category: 'food',
      photoUrl:
        'https://images.unsplash.com/photo-1557872943-16a5ac26437e?w=400&q=70',
    },
  ],
};
...
export const DEMO_SHARE: DemoShareFixture = {
  handle: '@kyoto.found',
  heroImageUrl:
    'https://images.unsplash.com/photo-1493997181344-712f2f19d87a?w=900&q=75',
