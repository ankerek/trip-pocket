...
| 7   | Comparison Table      | Life with vs without the app _(optional)_                                  |
| 8   | Preferences           | Functional personalisation that feeds the upcoming demo                    |
| 9   | Permission Priming    | Benefit-framed pre-sell before system permission dialogs _(auto-detected)_ |
...
```json
{
  "skills": ["github:adamlyttleapps/claude-skill-app-onboarding-questoinnaire"]
}
```
